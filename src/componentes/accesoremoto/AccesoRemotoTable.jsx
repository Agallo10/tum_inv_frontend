...
const initialColumns = [
  { key: "Plataforma", label: "Plataforma", visible: true },
  { key: "Usuario", label: "Usuario", visible: true },
  { key: "Contrasena", label: "Contraseña", visible: true },
  { key: "IDConexion", label: "ID Conexion", visible: true },
...
const AccesoRemotoTable = ({ allAccesosRemotos }) => {
  ...
  const descargaCsv = () => {
    ...
    exportToCsv(exportData, "accesosremotos.csv");
  };
...
export default AccesoRemotoTable;
