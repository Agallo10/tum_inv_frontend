...
const initialColumns = [
  { key: "DireccionIP", label: "Direccion IP", visible: true },
  { key: "AsignacionIP", label: "Asignacion IP", visible: true },
  { key: "NombreDispositivo", label: "Nombre de dispositivo", visible: true },
  { key: "Conectividad", label: "Conectividad", visible: true },
...
const ConfigRedTable = ({ allConfigRed }) => {
  ...
  const descargaCsv = () => {
    ...
    exportToCsv(exportData, "config-red.csv");
  };
